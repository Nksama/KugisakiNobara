...
def check_flood(update, context) -> str:
    ...
    try:
        ...
        if getmode == 1:
            ...
            execstrings = "Baaka spammer 😒\nMute {}enit\n ✵ Spammer : Beep Boop Banned!".format(getvalue)
            tag = "TMUTE"
        send_message(
...
def flood(update, context):
    ...
    if limit == 0:
        if conn:
            ...
            text = msg.reply_text("I'm not enforcing any flood control here But dont Spam For The Sake Of Anime!")
    else:
        if conn:
            text = msg.reply_text(
